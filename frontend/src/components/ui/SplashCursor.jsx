...
// Source : react-bits (https://reactbits.dev/animations/splash-cursor), MIT,
// récupérée telle quelle depuis github.com/DavidHDev/react-bits — vraie
// simulation fluide WebGL (pas de dépendance ajoutée, juste React). Seuls
// changements : retrait de la directive Next.js "use client" (inutile ici,
// projet Vite) et z-index remonté pour rester au-dessus des modales du site
// (ex. l'aperçu plein écran de la galerie) sans ambiguïté d'empilement.
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvasEl) {
      ...
      if (!isWebGL2)
        glCtx = canvasEl.getContext("webgl", params) || canvasEl.getContext("experimental-webgl", params);
