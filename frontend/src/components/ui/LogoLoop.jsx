/**
 * Bandeau de logos qui défile en boucle infinie sur une seule ligne (sans
 * dépendance externe). Le tableau est dupliqué une fois : la copie visible
 * + une copie aria-hidden, translatée de -50% en continu pour donner
 * l'illusion d'un défilement sans fin — aucun logo ne "disparaît" jamais,
 * il ressort par l'autre bord, jamais de retour à la ligne (flex-nowrap).
