...
> Ce README correspond à l'étape 3 (authentification + permissions). Il sera
> complété au fil des étapes suivantes (comptes de démo détaillés,
> déploiement, etc. à l'étape 8).
